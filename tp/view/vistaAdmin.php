    ...
    <div class="container mt-5 ">
        <div class="row">
            <div class="col-md-8 text-center">
                <h2 class="display-3">Gracias por trabajar en Infonete!</h2>
            </div>
            <div class="col-md-4">
    ...
    <div class="col-md-3">
        <div class="card  border-light" style="width: 14rem;">
            ...
            <div class="card-body">
                ...
                <a href="/usuario/editarRol" class="btn btn-primary btn-block">Editar</a>
            </div>
        </div>
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-3">
        <div class="card border-light" style="width: 14rem;">
            ...
            <div class="card-body">
                ...
                <a href="/usuario/generarPdfs" class="btn btn-primary btn-block">Generar</a>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-light" style="width: 14rem;">
            ...
            <div class="card-body">
                ...
                <a href="/usuario/estadisticasAdmin" class="btn btn-primary btn-block">Generar</a>
            </div>
        </div>
    </div>
</div>
