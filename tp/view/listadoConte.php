...
<div class="container mt-5 ">
    <h2 class="text-center">Accede al producto que desees</h2>
    <div class="row mt-5">
        <div class="col-md-3">
            <div class="card border-light" style="width: 14rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="/ejemplar/listaConte" class="btn btn-primary btn-block">Listar</a>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-light" style="width: 14rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="/seccion/listaConte" class="btn btn-primary btn-block">Listar</a>
                </div>
            </div>
           </div>
        ...
        <div class="col-md-3">
            <div class="card border-light" style="width: 14rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="/edicion/listaConte" class="btn btn-primary btn-block">Listar</a>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-light" style="width: 14rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="/noticia/listaConte" class="btn btn-primary btn-block">Listar</a>
                </div>
            </div>
        </div>
    </div>
